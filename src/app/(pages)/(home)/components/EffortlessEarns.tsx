...
import gradient from "../../../../assets/images/gradients.png";
...
const EffortlessEarns = () => {
  return (
    <>
      ...
      <div className="lg:px-[42px] lg:pt-[42px] px-5 pt-5 flex flex-col gap-2 rounded-[20px] bg-influences-Color">
        <h4 className="text-3xl font-medium ">
        ...
        >
          <div className="flex justify-between items-center">
            <div className="flex gap-1 items-center">
              ...
              <span className="ml-1 sm:text-sm text-[10px]">Jada</span>
          ...
          <p className="sm:text-[21px] text-lg mt-6 lg:w-4/5">
